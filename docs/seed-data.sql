...
('neon-pink-sunglasses', 'Neon Pink Sunglasses', 35.00, 'Vibrant neon pink sunglasses with Miami kitsch charm. Perfect for those sunny Florida days when you want to make a statement.', ARRAY['https://images.unsplash.com/photo-1572635196237-14b3f281503f?w=800&h=600&fit=crop'], 'active', 'fashion', ARRAY['sunglasses', 'neon', 'pink', 'miami']),
('flamingo-pool-float', 'Flamingo Pool Float', 25.00, 'Inflatable flamingo pool float with Miami kitsch design. Perfect for pool parties and beach days.', ARRAY['https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&h=600&fit=crop'], 'active', 'lifestyle', ARRAY['pool', 'float', 'flamingo', 'summer']),
('miami-vice-candle', 'Miami Vice Candle', 22.00, 'Scented candle with notes of coconut, lime, and ocean breeze. Inspired by the iconic Miami Vice aesthetic.', ARRAY['https://images.unsplash.com/photo-1603006905004-6f2c0c0c0c0c?w=800&h=600&fit=crop'], 'active', 'home', ARRAY['candle', 'scented', 'miami', 'vice']),
('alligator-keychain', 'Alligator Keychain', 15.00, 'Handcrafted alligator keychain made from recycled materials. A perfect Miami souvenir that''s both cute and eco-friendly.', ARRAY['https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&h=600&fit=crop'], 'active', 'accessories', ARRAY['alligator', 'keychain', 'recycled', 'miami']),
('coconut-shell-bowl', 'Coconut Shell Bowl', 28.00, 'Natural coconut shell bowl hand-carved and polished. Perfect for serving tropical fruits or as a decorative piece.', ARRAY['https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800&h=600&fit=crop'], 'active', 'home', ARRAY['coconut', 'bowl', 'natural', 'tropical']);
