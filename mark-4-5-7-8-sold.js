// Script to mark items 4, 5, 7, and 8 as SOLD
// Run with: node mark-4-5-7-8-sold.js
...
async function markItemsAsSold() {
  const itemsToMark = [4, 5, 7, 8];

  console.log('🔍 Checking current status of items 4, 5, 7, and 8...\n');
  ...
  console.log('\n✨ Migration complete! Items 4, 5, 7, and 8 are now marked as sold.');
  console.log('   They will appear on the website with "Out of Stock" overlays.');
}
